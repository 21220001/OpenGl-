...
{
	a+=20.0;	//Posisi pesawat lepas landas pada sumbu x
	b-=10.0;	//Gerakan mundur Jalur Jalan
	c+=15;	//lepas landas pada sudut tertentu pada sumbu y
	if(b<=-78.0)// pergerakan run way
		b=0.0;
	glutPostRedisplay();
...
glBegin(GL_POLYGON);//tubuh persegi panjang
glVertex2f(0.0,30.0);
glVertex2f(0.0,55.0);
...
glBegin(GL_POLYGON);//bidang konstruksi segitiga atas
glVertex2f(135.0,55.0);
...
glBegin(GL_LINE_LOOP);//garis luar bidang segitiga atas
glVertex2f(135.0,55.0);
glVertex2f(150.0,50.0);
glVertex2f(155.0,45.0);
glVertex2f(160.0,40.0);
...
glBegin(GL_POLYGON);//segitiga bawah
glVertex2f(135.0,40.0);
glVertex2f(160.0,40.0);
...
glTranslated(a,c,0.0);
glColor3f(1.0,0.0,0.0);
glBegin(GL_POLYGON);//sayap belakang
glVertex2f(0.0,55.0);
glVertex2f(0.0,80.0);
...
glTranslated(a,c,0.0);
glColor3f(1.0,0.0,0.0);
glBegin(GL_POLYGON);//sayap samping kiri
...
glPopMatrix();
if(c>360)    //timer untuk melompat ke tampilan berikutnya
{
	display2();
	d+=20;//pesawat lepas landas pada x di tampilan ke-2
}
if(a>500.0)//posisi jendela saat lepas landas
{
	a=0.0;
	b=0.0;
}
if(c>750)//timer untuk melompat ke tampilan ke-3
{
	display3();
	e+=20;//pesawat lepas landas pada x di tampilan ke-3
	if(e>250)//timer untuk memanggil fungsi ledakan
	{
		blast();
		e=250;
	}
...
glColor3f(0.60,0.40,0.70);
glBegin(GL_POLYGON);//segitiga atas bangunan
glVertex2f(400.0,400.0);
glVertex2f(350.0,480.0);
glVertex2f(400.0,480.0);
glEnd();
...
glColor3f(0.0,0.0,0.0);
glBegin(GL_LINES);//garis pemisah lantai
...
void build_outline()//membangun garis
{
glColor3f(0.0,0.0,0.0);
...
void blast(void)//konstruksi poligon ledakan
{
glPushMatrix();
...
glColor3f(0.0,0.0,0.0);
glBegin(GL_POLYGON);//jalan hitam
glVertex2f(0.0,0.0);
...
glColor3f(1.0,1.0,1.0);
glBegin(GL_POLYGON);//strip putih di jalan
glVertex2f(0.0,40.0);
glVertex2f(8.0,60.0);
